...
export type Database = {
  ...
  public: {
    Tables: {
      challenges: {
        Row: {
          ...
          recipient_id: string
          recipient_lc_memory_pct: number | null
          recipient_lc_runtime_pct: number | null
          recipient_time_ms: number | null
          sender_id: string
          sender_lc_memory_pct: number | null
          sender_lc_runtime_pct: number | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "challenges_sender_id_fkey"
            columns: ["sender_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      request_friendship: { Args: { target: string }; Returns: Json }
    }
    Enums: {
      challenge_state:
        | "pending"
